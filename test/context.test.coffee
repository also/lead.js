...
CoffeeScriptCell = require '../app/scripting/coffeescript'
...
render = (context) ->
  $result = $ '<div/>'
  # FIXME render doesn't work for the output after render tests
  React.render context.component(), $result.get(0)
  $result
