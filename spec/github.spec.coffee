define (require) ->
  ...
  describe 'github', ->
    it 'converts numbers to gist api urls', ->
      ...
      expect(gist_url.toString()).toBe 'https://api.github.com/gists/42'
    ...
    it 'converts gist urls to gist api urls', ->
      ...
      expect(gist_url.toString()).toBe 'https://api.github.com/gists/422'
    ...
    it 'converts gist repository urls to gist api urls', ->
      ...
      expect(gist_url.toString()).toBe 'https://api.github.com/gists/5794205'
    ...
    it 'handles repo contents api urls', ->
      ...
      expect(repo_url.toString()).toBe url

    it 'converts html urls to api urls', ->
      url = 'https://github.com/also/lead.js/blob/master/examples/browser.coffee'
      repo_url = github.to_repo_url url
      expect(repo_url.toString()).toBe 'https://api.github.com/repos/also/lead.js/contents/examples/browser.coffee?ref=master'

    it 'converts paths to api urls', ->
      path = 'also/lead.js/examples/browser.coffee'
      repo_url = github.to_repo_url path
      expect(repo_url.toString()).toBe 'https://api.github.com/repos/also/lead.js/contents/examples/browser.coffee'
